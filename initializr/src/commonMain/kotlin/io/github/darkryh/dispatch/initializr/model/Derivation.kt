 ...
 * [appVersion] — and *derives* `groupId`/`artifactId`. Power users can override the derived values
 * via [groupIdOverride]/[artifactIdOverride] (the "advanced" panel); `null` means "use the derived
 * value". This keeps the common path to three inputs while the generator still receives a full,
 * unchanged [ProjectConfig] (see [toProjectConfig]).
 */
