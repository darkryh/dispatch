...
data class BackgroundStyle(
    val topRule: BackgroundRule? = null,
    val bottomRule: BackgroundRule? = null,
    val fill: TextStyle? = null,
    val box: BackgroundBox? = null,
) {
    companion object {
        val None: BackgroundStyle = BackgroundStyle()
...
internal class BackgroundMeasurable(
    ...
    private fun renderRules(
        width: Int,
        topRule: BackgroundRule?,
        bottomRule: BackgroundRule?,
        fillStyle: TextStyle?,
