...
class ScrollStabilityReliabilityTest {
    ...
    fun `animation appearing does not cut off scrolling history`() {
        ...
        val linesWithoutAnimation = renderWithBoundedHeight {
        ...
        val linesWithAnimation = renderWithBoundedHeight {
            ChatScreenWithAnimation(
                messageCount = 5,
    ...
    fun `command palette appearing does not cut off scrolling history`() {
        ...
        val linesWithoutPalette = renderWithBoundedHeight {
        ...
        val linesWithPalette = renderWithBoundedHeight {
            ChatScreenWithCommandPalette(
                messageCount = 5,
    ...
    fun `multiple toggle cycles maintain scrolling stability`() {
        ...
        var lines = renderWithBoundedHeight {
    ...
    fun `rapid animation toggle does not lose history`() {
        ...
        repeat(10) { iteration ->
            ...
            val lines = renderWithBoundedHeight {
                ChatScreenWithAnimation(
                    messageCount = 5,
    ...
    fun `unbounded render preserves all messages when animation toggles`() {
        ...
        val linesWithoutAnimation = renderWithUnboundedHeight {
        ...
        // With animation
        val linesWithAnimation = renderWithUnboundedHeight {
    ...
    fun `verify virtualization behavior with bounded height`() {
        ...
        val visibleMessages = (0 until 20).filter { i ->
    ...
    private fun assertAllMessagesPresent(lines: List<String>, count: Int, context: String) {
