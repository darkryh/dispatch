 ...
 */
data class BoxAlignModifier(val alignment: Alignment.Alignment2D) : Modifier.Element {
 ...
 */
data class ColumnAlignModifier(val alignment: Alignment.Horizontal) : Modifier.Element {
 ...
 */
data class RowAlignModifier(val alignment: Alignment.Vertical) : Modifier.Element {
 ...
 */
fun Modifier.boxAlign(): Alignment.Alignment2D? =
    firstOrNull(BoxAlignModifier::class.java)?.alignment
 ...
 */
fun Modifier.columnAlign(): Alignment.Horizontal? =
    firstOrNull(ColumnAlignModifier::class.java)?.alignment
 ...
 */
fun Modifier.rowAlign(): Alignment.Vertical? =
    firstOrNull(RowAlignModifier::class.java)?.alignment
