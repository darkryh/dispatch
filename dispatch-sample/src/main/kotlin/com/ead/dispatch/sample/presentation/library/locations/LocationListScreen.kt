...
fun LocationListScreen(
    ...
    fun openSelected() {
        ...
        when (entry) {
            is ListEntry.Create -> {
                navigator.navigate(LocationEditorRoute(storyId = route.storyId, locationId = null))
            }
            is ListEntry.Item -> {
                navigator.navigate(LocationEditorRoute(storyId = route.storyId, locationId = entry.data.id))
            }
            null -> Unit
        }
    }
