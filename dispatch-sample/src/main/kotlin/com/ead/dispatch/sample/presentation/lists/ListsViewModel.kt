 ...
 *
 * @param menuChoice the last [com.ead.dispatch.widget.SelectMenu] item activated with Enter.
 * @param checkedCount how many rows are currently checked in the [com.ead.dispatch.widget.MultiSelectList].
 */
