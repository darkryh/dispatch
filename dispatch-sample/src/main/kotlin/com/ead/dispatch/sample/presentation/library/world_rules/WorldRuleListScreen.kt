...
fun WorldRuleListScreen(
    ...
    fun openSelected() {
        ...
        when (entry) {
            is ListEntry.Create -> {
                backStack.navigate(WorldRuleEditorRoute(storyId = route.storyId, worldRuleId = null))
            }
            is ListEntry.Item -> {
                backStack.navigate(WorldRuleEditorRoute(storyId = route.storyId, worldRuleId = entry.data.id))
            }
            null -> Unit
        }
    }
