...
fun TimelineAIDraftPreview(
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        PreviewRow("Time", draft.time, styles)
        PreviewRow("Order", draft.orderIndex?.toString(), styles)
        PreviewRow("Impact", draft.impact.joinToString(", "), styles)
        PreviewRow("Certainty", draft.certainty, styles)
