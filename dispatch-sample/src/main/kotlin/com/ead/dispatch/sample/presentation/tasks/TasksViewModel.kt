...
/** A task row rendered by the model-neutral [com.ead.dispatch.widget.TaskList] overload. */
data class DemoTask(
    val title: String,
    val detail: String,
)

/** Item labels driving the [com.ead.dispatch.widget.Checklist] preview. */
val CHECKLIST_ITEMS = listOf("Fetch deps", "Compile", "Run tests", "Package", "Publish")

/** Seed rows for the [com.ead.dispatch.widget.TaskList] preview. */
val DEMO_TASKS =
    listOf(
