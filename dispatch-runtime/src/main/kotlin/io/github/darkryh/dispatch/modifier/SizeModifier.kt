 ...
 */
fun Modifier.fillMaxSize(fraction: Float = 1f): Modifier = fillMaxWidth(fraction).fillMaxHeight(fraction)
...
private class FillMaxHeightModifier(
    private val fraction: Float,
) : SizeModifier {
    override fun modifyConstraints(constraints: Constraints): Constraints {
...
private class WidthModifier(
    private val chars: Int,
) : SizeModifier {
    override fun modifyConstraints(constraints: Constraints): Constraints {
...
private class WidthInModifier(
    ...
    override fun equals(other: Any?): Boolean = other is WidthInModifier && other.min == min && other.max == max
...
private class HeightInModifier(
    private val min: Int,
    private val max: Int,
) : SizeModifier {
    override fun modifyConstraints(constraints: Constraints): Constraints =
    ...
    override fun equals(other: Any?): Boolean = other is HeightInModifier && other.min == min && other.max == max
