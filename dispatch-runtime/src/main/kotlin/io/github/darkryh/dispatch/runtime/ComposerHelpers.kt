...
fun <T : Measurable> composableWidget(
    ...
    ComposeNode<io.github.darkryh.dispatch.layout.LayoutNode, DispatchNodeApplier>(
        factory = {
            io.github.darkryh.dispatch.layout
                .LayoutNode(name)
        },
        update = {
...
private class DynamicChildrenMeasurable(
    ...
    override fun measure(constraints: Constraints): Placeable = measurableFactory(children()).measure(constraints)
}
