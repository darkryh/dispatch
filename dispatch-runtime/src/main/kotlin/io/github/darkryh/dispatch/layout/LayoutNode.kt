...
import io.github.darkryh.dispatch.modifier.SemanticsTagModifier
import io.github.darkryh.dispatch.modifier.allOf
...
class LayoutNode(
    ...
    /**
     * Semantic tags attached via [io.github.darkryh.dispatch.modifier.semantics].
     *
     * Computed lazily and cached; invalidated whenever the modifier changes.
     */
    val semanticsTags: List<String>
        get() =
            cachedSemanticsTags ?: modifier
                .allOf<SemanticsTagModifier>()
                .map { it.tag }
