...
interface Modifier {
    ...
    interface Element : Modifier {
        ...
        override fun <T : Element> allOf(type: Class<T>): List<T> = if (type.isInstance(this)) listOf(this as T) else emptyList()

        override infix fun then(other: Modifier): Modifier = if (other === Companion) this else CombinedModifier(this, other)
    }
...
internal class CombinedModifier(
    ...
    override fun then(other: Modifier): Modifier = if (other === Modifier) this else CombinedModifier(this, other)
