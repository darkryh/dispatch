package io.github.darkryh.dispatch.constraints
...
data class Constraints(
    ...
    fun constrain(
        width: Int,
        height: Int,
    ): Pair<Int, Int> = constrainWidth(width) to constrainHeight(height)
    ...
    companion object {
         ...
         * @param width Exact width.
         */
        fun fixedWidth(width: Int): Constraints = Constraints(width, width, 0, Int.MAX_VALUE)
         ...
         * @param height Exact height.
         */
        fun fixedHeight(height: Int): Constraints = Constraints(0, Int.MAX_VALUE, height, height)
        ...
        fun maxSize(
            width: Int,
            height: Int,
        ): Constraints = Constraints(0, width, 0, height)
        ...
        fun minSize(
            width: Int,
            height: Int,
        ): Constraints = Constraints(width, Int.MAX_VALUE, height, Int.MAX_VALUE)
    }
}
