...
internal fun encodeNavKeyPayload(key: NavKey, json: Json = DefaultRouteJson): String {
...
internal fun encodeNavKeyForSave(key: NavKey, json: Json = DefaultRouteJson): String {
...
internal fun decodeNavKeyFromSave(encoded: String, json: Json = DefaultRouteJson): NavKey {
