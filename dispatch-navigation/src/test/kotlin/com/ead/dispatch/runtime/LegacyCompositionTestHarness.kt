...
class Composer : AutoCloseable {
    ...
    fun getRootNode(): LayoutNode? =
        composition.root.children.singleOrNull() ?: composition.root.takeIf { it.children.isNotEmpty() }
...
fun withComposer(composer: Composer, block: @Composable () -> Unit) = composer.setContent(block)
